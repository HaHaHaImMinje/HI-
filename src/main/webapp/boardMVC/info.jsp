...
<!-- Bootstrap Core CSS -->
<link href="/springWeb/boardMVC/css/bootstrap.min.css" rel="stylesheet">
<!-- Custom CSS -->
<link href="/springWeb/boardMVC/css/clean-blog.css" rel="stylesheet">
<link href="/springWeb/boardMVC/css/board.css" rel="stylesheet">
<!-- Custom Fonts -->
<link
...
<script type="text/javascript">
	$(function() { 
		...
		$(".btn.btn-default.btn-xs").click(function() {
			...
			document.location.href = '/springWeb/boardMVC/password.jsp?no=' + $
			{
				info.no
			}
			+'&job=' + this.lang;
		...
		<div class="list-group">
			<div class="list-group-item board-title">
				...
				<div class="board-meta"
					...
					<p>
						<i class="glyphicon glyphicon-user">${info.author}</i> <i
							class="glyphicon glyphicon-comment">${info.reply}</i> <i
							class="glyphicon glyphicon-ok">${info.hit}</i> <i
							class="glyphicon glyphicon-time">${info.regdate}</i> <i
			...
			<div class="list-group-item">
				<span><img src='/springWeb/upload/${info.fileName}'
					width="200" height="200"></span> <span class="board-contents">
					${info.contents}</span>
			...
			<div class="bottom"
				...
				<a href="#" class="btn btn-default btn-xs" lang="mod">수정</a> <a
					href="#" class="btn btn-default btn-xs" lang="del">삭제</a> <a
					href="/springWeb/boardMVC/write.jsp?job=reply&ref=${info.ref}&step=${info.step}&lev=${info.lev}&pnum=${info.no}"
					class="btn btn-default btn-xs">답글</a> <a href="#"
					class="btn btn-default btn-xs"><span id="scrap">스크랩</span></a>
			</div>
			<div class="clear"></div>
		</div>
	</div>
