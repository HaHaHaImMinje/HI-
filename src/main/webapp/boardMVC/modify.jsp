...
<body>
	...
	<div class="board-field">
		<form action="/springWeb/modifyProcessAction.do" method="post">
			<div class="list-group">
				<div class="list-group-item board-title">
					<div class="board-title">
						<span class="board-category">[TITLE]</span><a href="#"> <input
							name="title" value="${info.title }" style="height: 25px;">
						</a>
					</div>
					<div class="board-meta"
						style="font-weight: 400; font-size: 1.2rem; color: #404040">
						<p>
							<i class="glyphicon glyphicon-user"><input type="text"
								name="author" value="${info.author }"> 님</i> <input
								type="hidden" name="no" value="${info.no}"> <i
				...
				<div class="list-group-item">
					<span class="board-contents"> <textarea name="contents"
							cols="180" rows="10">${info.contents}</textarea>
					</span>
				...
				<div class="bottom"
					...
					<a href="#" class="btn btn-default btn-xs" lang="mod"><span
						id="mod">수정</span></a> <a
						href="/springWeb/boardMVC/boardInfo.do?no=${info.no}&job=info"
						class="btn btn-default btn-xs" lang="del">취소</a>
				</div>
				<div class="clear"></div>
			</div>
		</form>
