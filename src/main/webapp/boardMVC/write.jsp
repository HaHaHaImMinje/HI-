...
<body>
	...
	<form action="/springWeb/boardInsert.do" method="post" name="insertFrm" enctype="multipart/form-data">
		<!-- 생략 -->
		<div id="write-field">
			...
			<div class="col-md-6">
				<table>
					...
					<tr>
						...
						<input type="text" name="title" value="" class="form-control input-sm bskr-font subject" /> 
				...
				<div class="form-group">
					<table>
						<tr>
							<td class="td1"></td>
							<td class="td2"><textarea name="contents"
									class="form-control col-sm-5" rows="20"></textarea></td>
						</tr>
						<tr>
							<td class="td1"></td>
							<td class="td2"><input type="file" id="InputFile"
								name="file"></td>
						</tr>
					</table>
				</div>
