...
<script type="text/javascript" src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
	<script type="text/javascript">
		$(function() {
			//$("tag 특수문자 : .class , #id , ','tag , []attribute ")
			$(".btn.btn-sm.btn-info.btn-block").click(function(){
	...
	<div class="container" style="margin-top: 120px">
		<div class="row">
			<div class="main">
				...
				<form method="post" action="/springWeb/passWordConfirm.do">
					<div class="form-group">
						<input type="text" class="form-control" name="cp" id="pass" /> 
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<a href="#" class="btn btn-sm btn-info btn-block">PassCheck</a>
						</div>
					</div>
				</form>
			</div>
