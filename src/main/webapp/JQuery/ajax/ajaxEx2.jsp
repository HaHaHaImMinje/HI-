...
<script type="text/javascript">
		...
		$.ajax({
			...
			success : function(value) {
				...
				case 'obj':
					...
					$(value).each(function(index, dom) { //jquery 사용

								console.log(index + ' ' + dom.empno + ' '
										+ dom['empno']);
	...
	$(function() {
		$("button").click(
				function() {
					if (this.id == 'btn1') {
						ajaxProcess('/web/JQuery/ajaxData/dataValue1.jsp',
								'text', 'POST', 'str');
					} else if (this.id == 'btn2') {
						ajaxProcess('/web/JQuery/ajaxData/dataValue2.jsp',
								'text', 'POST', 'str');
