...
<script type="text/javascript">
	ajaxRequest('/Web/ajaxDefaultList.do','json');	
   function delFun(no){
   ...
   function ajaxReplyList(v){
	   var temp="";
		 $.each(v,function(index,dom){
			 ...
			 temp+="<a href=\"javascript:fun()\">답글</a><span class=\"txt_bar\">|</span><a href=\"#none\">수정</a><span class=\"txt_bar\">|</span><a href='javascript:delFun("+dom.no+")'>삭제</a><span class=\"txt_bar\">|</span><a href=\"#none\">신고</a>";
			 temp+="</div>";
			 temp+="</div>";
   ...
   $(function(){
	   ...
	   $("textarea.tf_cmt").focus(function(){
		 ...
		 if('${id}'==null||'${id}'==''){
			 alert('LoginCheck!');
			 $(this).blur();
			 document.location.href='/Web/springAjax/basic/signin.jsp';
		 }
	   });
